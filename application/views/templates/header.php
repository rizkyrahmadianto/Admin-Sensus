    ...
    <aside id="left-panel" class="left-panel">
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?= base_url(); ?>home/index"><img src="<?= base_url(); ?>assets/images/logo.png" alt="Logo"></a>
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav" id="ulCategory">
                    ...
                    <li>
                        <a href="<?= base_url(); ?>home/index" > <i class="menu-icon fa fa-dashboard"></i>Dashboard </a>
                    </li>
                    <h3 class="menu-title">Master</h3><!-- /.menu-title -->
                    <li>
                        <a href="<?= base_url(); ?>region/index"> <i class="menu-icon ti-world"></i>Regions </a>
                    </li>
                    <li>
                        <a href="<?= base_url(); ?>person/index" > <i class="menu-icon ti-user"></i>Person </a>
                    </li>
                </ul>
            </div><!-- /.navbar-collapse -->
        </nav>
                ...
                <div class="col-sm-5">
                    <div class="user-area dropdown float-right">
                        <!-- <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <span class="mr-sm-3 d-none d-lg-inline text-gray-600 small"><?php echo $user['name']; ?></span>
                            <img class="user-avatar rounded-circle" src="<?= base_url(); ?>assets/images/profile/<?php echo $user['image'] ?>" alt="User Avatar">
                        </a> -->
                    ...
                    <!-- <div class="language-select dropdown" id="language-select">
                        <a class="dropdown-toggle" href="#" data-toggle="dropdown"  id="language" aria-haspopup="true" aria-expanded="true">
                            <i class="flag-icon flag-icon-id" alt="Indonesia"></i>
                        </a>
